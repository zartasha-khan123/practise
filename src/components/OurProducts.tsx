...
function OurProducts() {
  return (
    <>
      <section className="w-full mt-8 px-4 sm:px-6 md:px-8 lg:px-16">
        <RedHeading text="Our Products" textColor="red" />

        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <h2 className="text-lg sm:text-2xl md:text-3xl leading-6 sm:leading-8 md:leading-10 font-semibold text-center sm:text-left">
            Explore Our Products
          </h2>
          ...
          {productArray.map((item, index) => {
            return (
              <Card className="w-full h-full overflow-hidden" key={index}>
                ...
                {/* Bottom div */}
                <div className="w-full flex flex-col gap-2 text-sm sm:text-base leading-5 sm:leading-6 font-medium px-2">
                  ...
                  {item.colordiv && (
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-5 h-5 rounded-full border border-black bg-${item.color1}-500`}
                      ></div>
                      <div
                        className={`w-5 h-5 rounded-full bg-${item.color2}-500`}
                      ></div>
                    </div>
                  )}
                </div>
        ...
        <div className="text-center mt-10">
          <button className="bg-[#DB4444] py-3 px-6 sm:py-4 sm:px-8 hover:bg-gray-600 text-white">
            View All Products
          </button>
        </div>
      </section>
